// ignore_for_file: non_constant_identifier_names, prefer_typing_uninitialized_variables, library_private_types_in_public_api, unused_element
...
class MovieDetailBean {
  ...
  factory MovieDetailBean(jsonStr) => jsonStr is String ? MovieDetailBean.fromJson(json.decode(jsonStr)) : MovieDetailBean.fromJson(jsonStr);
  ...
  MovieDetailBean.fromJson(jsonRes) {
    ...
    images = jsonRes['images'] == null ? null : _Image.fromJson(jsonRes['images']);
    rating = jsonRes['rating'] == null ? null : Rating.fromJson(jsonRes['rating']);
  }
...
class Rating {
  ...
  Rating.fromJson(jsonRes) {
    ...
    stars = jsonRes['stars'];
    details = jsonRes['details'] == null ? null : RatingDetails.fromJson(jsonRes['details']);
  }
...
class Writer {
  ...
  Writer.fromJson(jsonRes) {
    ...
    avatars = jsonRes['avatars'] == null ? null : WriterAvatars.fromJson(jsonRes['avatars']);
  }
...
class PopularReview {
  ...
  PopularReview.fromJson(jsonRes) {
    ...
    summary = jsonRes['summary'];
    title = jsonRes['title'];
    author = jsonRes['author'] == null ? null : PopularReviewAuthor.fromJson(jsonRes['author']);
    rating = jsonRes['rating'] == null ? null : PopularReviewRating.fromJson(jsonRes['rating']);
  }
...
class PopularComment {
  ...
  PopularComment.fromJson(jsonRes) {
    ...
    id = jsonRes['id'];
    subject_id = jsonRes['subject_id'];
    author = jsonRes['author'] == null ? null : PopularCommentAuthor.fromJson(jsonRes['author']);
    rating = jsonRes['rating'] == null ? null : PopularCommentRating.fromJson(jsonRes['rating']);
  }
...
class Director {
  ...
  Director.fromJson(jsonRes) {
    ...
    name = jsonRes['name'];
    name_en = jsonRes['name_en'];
    avatars = jsonRes['avatars'] == null ? null : DirectorAvatars.fromJson(jsonRes['avatars']);
  }
...
class Cast {
  ...
  Cast.fromJson(jsonRes) {
    ...
    name = jsonRes['name'];
    name_en = jsonRes['name_en'];
    avatars = jsonRes['avatars'] == null ? null : CastAvatars.fromJson(jsonRes['avatars']);
  }
