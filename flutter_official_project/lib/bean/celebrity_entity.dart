// ignore_for_file: unnecessary_string_interpolations, non_constant_identifier_names, unused_element, prefer_typing_uninitialized_variables, library_private_types_in_public_api
...
class CelebrityEntity {
  ...
  factory CelebrityEntity(jsonStr) => jsonStr is String ? CelebrityEntity.fromJson(json.decode(jsonStr)) : CelebrityEntity.fromJson(jsonStr);
  ...
  CelebrityEntity.fromJson(jsonRes) {
    ...
    for (var worksItem in works == null ? [] : jsonRes['works']) {
      works?.add(Work.fromJson(worksItem));
    }

    avatars = jsonRes['avatars'] == null ? null : Avatars.fromJson(jsonRes['avatars']);
  }
...
class Work {
  ...
  Work.fromJson(jsonRes) {
    ...
    subject = jsonRes['subject'] == null ? null : WorkSubject.fromJson(jsonRes['subject']);
  }
...
class WorkSubject {
  ...
  WorkSubject.fromJson(jsonRes) {
    ...
    for (var castsItem in casts == null ? [] : jsonRes['casts']) {
      casts?.add(CastDict.fromJson(castsItem));
    }
...
class Rating {
  ...
  Rating.fromJson(jsonRes) {
    ...
    stars = jsonRes['stars'];
    details = jsonRes['details'] == null ? null : Detail.fromJson(jsonRes['details']);
  }
