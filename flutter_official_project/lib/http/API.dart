// ignore_for_file: constant_identifier_names, prefer_final_fields, prefer_interpolation_to_compose_strings, prefer_const_constructors, unnecessary_null_comparison, file_names

import 'dart:math' as math;
import 'package:flutter/material.dart';
import 'package:flutter_official_project/bean/celebrity_entity.dart' as celebrity;
...
class API {
  ...
  void getWeekly(RequestCallBack requestCallBack) async {
    ...
    var resultList = result['subjects'];
    List<SubjectEntity> list = resultList.map<SubjectEntity>((item) => SubjectEntity.fromMap(item)).toList();
    requestCallBack(list);
  }
